package com.example.contact.api.config;
...
import static com.example.contact.api.constant.Constant.X_REQUESTED_WITH;
...
public class CorsConfig {
    ...
    public CorsFilter corsFilter(){
        ...
        corsConfiguration.setAllowedOrigins(List.of("http://localhost:3000", "http://localhost:3001", "http://localhost:3002"));
